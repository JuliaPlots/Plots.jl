...
const _arg_desc = KW(
    ...
    :margin => "Measure (multiply by `mm`, `px`, etc) or Tuple such as `(0, :mm)`. Base for individual margins... not directly used. Specifies the extra padding around subplots.",
    :left_margin => "Same as `:margin` or `:match` (matches `:margin`). Specifies the extra padding to the left of the subplot.",
    :top_margin => "Same as `:margin` or `:match` (matches `:margin`). Specifies the extra padding on the top of the subplot.",
    :right_margin => "Same as `:margin` or `:match` (matches `:margin`). Specifies the extra padding to the right of the subplot.",
    :bottom_margin => "Same as `:margin` or `:match` (matches `:margin`). Specifies the extra padding on the bottom of the subplot.",
