...
const _arg_desc = KW(
    ...
    :xerror_linestyle        => "Symbol. Style of the y error bar line (for path and bar stroke).  Choose from $(_allStyles). Value of `nothing` will match the supplied `:linestyle`.",
    :yerror_linestyle        => "Symbol. Style of the x error bar line (for path and bar stroke).  Choose from $(_allStyles). Value of `nothing` will match the supplied `:linestyle`.",
