...
const _arg_desc = KW(
    ...
    :seriestype         => (Symbol, "This is the identifier of the type of visualization for this series. Choose from $(Commons._allTypes) or any series recipes which are defined."),
    :linestyle          => (Symbol, "Style of the line (for path and bar stroke). Choose from $(Commons._allStyles)"),
    ...
    :markershape        => (Union{Symbol,Shape,AVec}, "Choose from $(Commons._allMarkers)."),
    ...
    :markerstrokestyle  => (Symbol, "Style of the marker stroke (border). Choose from $(Commons._allStyles)."),
    ...
    :colorbar_scale              => (Symbol, "Scale of the colorbar axis. Choose from $(Commons._allScales)."),
    ...
    :framestyle                  => (Symbol, "Style of the axes frame. Choose from $(Commons._allFramestyles)."),
    ...
    :scale                       => (Symbol, "Scale of the axis. Choose from $(Commons._allScales)."),
    ...
    :gridstyle                   => (Symbol, "Style of the grid lines. Choose from $(Commons._allStyles)."),
    ...
    :minorgridstyle              => (Symbol, "Style of the minor grid lines. Choose from $(Commons._allStyles)."),
