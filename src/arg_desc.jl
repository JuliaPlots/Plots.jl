...
const _arg_desc = KW(
    ...
    :fillrange          => (Union{Real,AVec}, "Fills area between fillrange and y for line-types, sets the base for bar/stick types, and similar for other types."),
    ...
    :foreground_color_guide      => (ColorType, "Color of axis guides (axis labels). `:match` matches `:foreground_color_subplot`."),
