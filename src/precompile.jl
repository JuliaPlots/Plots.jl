function _precompile_()
    ...
    precompile(Tuple{typeof(Plots.fix_colorgradient!), Base.Dict{Symbol, Any}})
    ...
    precompile(Tuple{typeof(Plots.expand_extrema!), Plots.Axis, Plots.Surface{Array{Float64, 2}}})
    precompile(Tuple{typeof(Plots.expand_extrema!), Plots.Axis, Array{Float64, 1}})
    precompile(Tuple{typeof(Plots.slice_arg!), Base.Dict{Symbol, Any}, Base.Dict{Symbol, Any}, Symbol, Array{ColorTypes.RGBA{Float64}, 1}, Int64, Bool})
    ...
    precompile(Tuple{typeof(Plots.default), Symbol, Array{ColorTypes.RGBA{Float64}, 1}})
    ...
    isdefined(Plots, Symbol("#kw##default")) && precompile(Tuple{getfield(Plots, Symbol("#kw##default")), NamedTuple{(:palette,), Tuple{Array{ColorTypes.RGBA{Float64}, 1}}}, typeof(Plots.default)})
    precompile(Tuple{typeof(Plots.expand_extrema!), Plots.Axis, Array{Int64, 1}})
