...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(_compute_xyz),Vector{Float64},Vector{Float64},UnitRange{Int64},Bool})
    ...
    Base.precompile(Tuple{typeof(_series_data_vector),StepRangeLen{Float64, Base.TwicePrecision{Float64}, Base.TwicePrecision{Float64}, Int64},Dict{Symbol, Any}})
