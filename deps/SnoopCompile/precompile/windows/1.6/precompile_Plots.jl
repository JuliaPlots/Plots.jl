...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Core.Compiler.:(==)),Core.PhiNode,Tuple{typeof(Plots.left),Int64}})
    ...
    Base.precompile(Tuple{typeof(Plots.is_marker_supported),Plots.GRBackend,Symbol})
    ...
    Base.precompile(Tuple{typeof(RecipesPipeline._expand_seriestype_array),Dict{Symbol,Any},Tuple{Plots.PortfolioComposition}})
    Base.precompile(Tuple{typeof(RecipesPipeline._expand_seriestype_array),Dict{Symbol,Any},Tuple{Plots.Spy}})
