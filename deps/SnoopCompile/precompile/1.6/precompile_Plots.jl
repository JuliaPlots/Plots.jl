...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(attr!)),NamedTuple{(:tickfontsize,), Tuple{Int64}},typeof(attr!),Axis})
    ...
    Base.precompile(Tuple{typeof(process_annotation),Subplot{PlotlyBackend},Vector{String},Vector{String},Vector{PlotText}})
