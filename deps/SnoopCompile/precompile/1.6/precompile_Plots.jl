...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol, Any},Type{Val{:xerror}},Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(_slice_series_args!),DefaultsDict,Plot{PlotlyBackend},Subplot{PlotlyBackend},Int64})
