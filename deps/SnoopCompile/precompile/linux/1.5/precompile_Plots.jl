...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(plot)),NamedTuple{(:title,),Tuple{String}},typeof(plot),Array{Float64,1}})
    ...
    Base.precompile(Tuple{typeof(RecipesPipeline.slice_series_attributes!),Plot{GRBackend},Array{Dict{Symbol,Any},1},Dict{Symbol,Any}})
    ...
    Base.precompile(Tuple{typeof(attr),EmptyLayout,Symbol})
