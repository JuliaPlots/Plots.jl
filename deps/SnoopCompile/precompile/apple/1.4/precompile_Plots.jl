...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(Plots.gr_draw_border),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64,Float64}},Function})
    Base.precompile(Tuple{typeof(Plots.gr_draw_border),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64}},Function})
    ...
    Base.precompile(Tuple{typeof(Plots.gr_draw_ticks),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64,Float64}},Function})
    Base.precompile(Tuple{typeof(Plots.gr_draw_ticks),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64}},Function})
    Base.precompile(Tuple{typeof(Plots.gr_draw_ticks),Plots.Subplot{Plots.GRBackend},Plots.Axis,Segments{Tuple{Float64,Float64}}})
    ...
    Base.precompile(Tuple{typeof(Plots.is_marker_supported),Plots.GRBackend,Array{Symbol,1}})
