...
function _precompile_()
    ...
    Base.precompile(Tuple{Core.kwftype(typeof(attr!)),NamedTuple{(:guidefonthalign, :mirror, :guide), Tuple{Symbol, Bool, String}},typeof(attr!),Axis})
    Base.precompile(Tuple{Core.kwftype(typeof(attr!)),NamedTuple{(:guidefontvalign, :mirror, :guide), Tuple{Symbol, Bool, String}},typeof(attr!),Axis})
