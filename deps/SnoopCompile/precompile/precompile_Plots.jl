...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:wireframe}},Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(RecipesPipeline.slice_series_attributes!),Plot{PlotlyBackend},Array{Dict{Symbol,Any},1},Dict{Symbol,Any}})
    ...
    Base.precompile(Tuple{typeof(error_coords),Array{Float64,1},Array{Float64,1},Array{Float64,1},Vararg{Array{Float64,1},N} where N})
    ...
    Base.precompile(Tuple{typeof(gr_w3tondc),Float64,Float64,Float64})
