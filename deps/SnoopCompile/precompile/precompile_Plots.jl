...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(RecipesBase.apply_recipe),Dict{Symbol,Any},Type{Val{:histogram2d}},Plot{GRBackend}})
    ...
    Base.precompile(Tuple{typeof(_slice_series_args!),Dict{Symbol,Any},Plot{PlotlyBackend},Subplot{PlotlyBackend},Int64})
