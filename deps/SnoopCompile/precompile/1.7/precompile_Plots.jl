...
function _precompile_()
    ...
    Base.precompile(Tuple{typeof(iter_segments),StepRange{Int64, Int64},Vararg{Any}})
    ...
    isdefined(Plots, Symbol("#add_major_or_minor_segments#104")) && Base.precompile(Tuple{getfield(Plots, Symbol("#add_major_or_minor_segments#104")),Vector{Int64},Bool,Segments{Tuple{Float64, Float64}},Float64,Bool})
