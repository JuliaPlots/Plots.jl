...
const _gruvbox_dark = PlotTheme(
    Dict([
        ...
        :palette => expand_palette(
            ...
            [_gruvbox_colors[c] for c ∈ _gruvbox_dark_palette],
        ),
        :colorgradient => cgrad(:YlOrRd, rev = true),
    ]),
)

const _gruvbox_light = PlotTheme(
    Dict([
        ...
        :palette => expand_palette(
            ...
            [_gruvbox_colors[c] for c ∈ _gruvbox_light_palette],
        ),
        :colorgradient => cgrad(:YlOrRd, rev = true),
    ]),
)
