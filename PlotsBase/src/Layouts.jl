module Layouts
    export origin, left, top, right, bottom, bbox, bbox_to_pcts, xy_mm_to_pcts
    export ispositive, GridLayout, EmptyLayout, RootLayout
    ...
    PlotsBase.attr(layout::AbstractLayout, k::Symbol) = layout.attr[k]
    PlotsBase.attr(layout::AbstractLayout, k::Symbol, v) = get(layout.attr, k, v)
    PlotsBase.attr!(layout::AbstractLayout, v, k::Symbol) = (layout.attr[k] = v)
