...
# the indexed methods take at least one argument, else `push!(plt, 4)` would read the `4` as a
...
# the un-indexed `append!` also takes at least one argument, else the `Real` and the
