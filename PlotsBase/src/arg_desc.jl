...
const _arg_desc = KW(
    ...
    :colorbar_tickfont => (Font, "Font of colorbar tick entries."),
    :colorbar_tickcolor => (ColorType, "Color of colorbar tick marks."),
    :colorbar_ticklinewidth => (Real, "Line width of colorbar tick marks."),
    :colorbar_bordercolor => (ColorType, "Color of the colorbar border."),
    :colorbar_borderlinewidth => (Real, "Line width of the colorbar border."),
    :colorbar_width => (Union{Real, Symbol}, "Width of the colorbar as a fraction of the subplot viewport (`:auto` uses the backend default)."),
    :colorbar_height => (Union{Real, Symbol}, "Height of the colorbar as a fraction of the subplot viewport (`:auto` uses the backend default)."),
