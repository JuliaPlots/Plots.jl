...
const _arg_desc = KW(
    ...
    :colorbar_bordercolor => (ColorType, "Border color of the colorbar."),
    :colorbar_borderwidth => (Union{Real, Symbol}, "Border width of the colorbar in pixels. Use `:auto` for the backend default."),
