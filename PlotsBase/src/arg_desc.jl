...
const _arg_desc = KW(
    ...
    :colorbar_tickcolor => (ColorType, "Color of the colorbar tick marks."),
    :colorbar_ticklinewidth => (Union{Real, Symbol}, "Width of the colorbar tick marks. `:auto` keeps the backend default."),
