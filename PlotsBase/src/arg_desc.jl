...
const _arg_desc = KW(
    ...
    :colorbar_width => (Union{Real, Symbol}, "Width of the colorbar as a normalized device-coordinate fraction, or `:auto`."),
    :colorbar_height => (Union{Real, Symbol}, "Height of the colorbar as a normalized device-coordinate fraction, or `:auto`."),
