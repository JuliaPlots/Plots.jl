...
with(:gr) do
    ...
    @testset "colorbar dimensions" begin
        pl = heatmap(reshape(1:9, 3, 3); colorbar_width = 0.04, colorbar_height = 0.5)
        @test pl[1][:colorbar_width] == 0.04
        @test pl[1][:colorbar_height] == 0.5
